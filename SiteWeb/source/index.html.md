...
* La partie exploration consiste à faire en sorte que l'IA explore son environnement de manière complètement aléatoire, ce qui veut dire que quelque soit l'état dans lequel on est, l'action est aléatoire.
